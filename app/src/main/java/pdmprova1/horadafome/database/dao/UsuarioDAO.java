...
public class UsuarioDAO extends AbstractDAO {
    ...
    public long Insert(final String nome, final String telefone, final Integer n_pessoas, final Date hora_da_reserva, final Boolean area_externa, final Boolean rodizio, final Boolean a_la_carte) {
		...
		values.put(UsuarioModel.COLUNA_HORA_DA_RESERVA, hora_da_reserva.getTime());
        ...
        long result = db.insert(UsuarioModel.tabela_usuario, null, values);
    ...
    public long Update(final String nome, final String telefone, final Integer n_pessoas, final Long hora_da_reserva, final Boolean area_externa, final Boolean rodizio, final Boolean a_la_carte) {

        open();

        ContentValues values = new ContentValues();
        values.put(UsuarioModel.COLUNA_TELEFONE, telefone);
		values.put(UsuarioModel.COLUNA_HORA_DA_RESERVA, String.valueOf(hora_da_reserva));
		values.put(UsuarioModel.COLUNA_N_PESSOAS, n_pessoas);
		values.put(UsuarioModel.COLUNA_AREA_EXTERNA, area_externa);
		values.put(UsuarioModel.COLUNA_RODIZIO, rodizio);
		values.put(UsuarioModel.COLUNA_LA_CARTE, a_la_carte);

        long result = db.update(UsuarioModel.tabela_usuario, values, UsuarioModel.COLUNA_TELEFONE + " = ?", new String[]{telefone});
    ...
    public long Delete(final String usuario) {
        ...
        long result = db.delete(UsuarioModel.tabela_usuario, UsuarioModel.COLUNA_TELEFONE + " = ?", new String[]{usuario});
    ...
    public final UsuarioModel CursorToStructure(Cursor cursor) {
		...
		model.setHora_da_reserva(cursor.getLong(3));
