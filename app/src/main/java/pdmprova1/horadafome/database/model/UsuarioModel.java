...
public class UsuarioModel {
    ...
    public static final String
    CREATE_TABLE = "create table "+tabela_usuario
                    +" ( "
                    +COLUNA_ID+" integer primary key autoincrement, "
                    +COLUNA_NOME+" text not null, "
					+COLUNA_HORA_DA_RESERVA+" long not null, "
					+COLUNA_HORA_DA_RESERVA+" long not null, "
    ...
    public static final String
    DROP_TABLE = "drop table if exists "+tabela_usuario+";";

	public static final String INNER_JOIN = "SELECT * FROM " +tabela_usuario+"INNER JOIN tabela_mesas WHERE tabela_mesas.usuario_id = tabela_usuario.id";
	...
	public Long getHora_da_reserva() {
		return hora_da_reserva;
	}

	public void setHora_da_reserva(Long hora_da_reserva) {
